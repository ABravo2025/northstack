...
- **components/tasks/TaskHubList** / **TaskHubRow** — vista lista: sin agrupar por día/semana (a pedido explícito), ordenada por fecha, columnas Created/Due/Completed. Título de la fila siempre arranca con `entitySummary` en negrita.
