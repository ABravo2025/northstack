...
- Última actualización: 2026-08-30 (Activity Log Unidades 1-5 — schema + mecanismo genérico + wiring de Employee/Company/Contact/Opportunity + frontend + HR/Payroll + resto de CRM/cross-module/vistas, ver grupo 13; en `staging`, sin pushear a `main`)
