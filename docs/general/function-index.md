...
### `src/modules/integrations/stripePaymentsService.ts` (Payments v1, `docs/tareas/specpaymentsv1.md`, Units 2-3 — 2026-08-26)
Lookup/matching Company↔Stripe Customer y visibilidad de pagos en vivo, sin store local. El ownership de la Company (tenantId) se valida en la ruta (`routes/payments.ts`), no acá — estas funciones reciben una Company ya validada.
