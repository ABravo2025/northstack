...
- Última actualización: 2026-07-16 (rebrand de Settings: tareas 1-3 de 4 implementadas — Custom Fields, Statuses y PTO Policies ya salieron de `/settings`; falta la 4ta, Workspace Settings; Vistas guardadas — Views/Filtros/Kanban — implementadas completas; las "Notas de avance" fechadas se movieron a `docs/tareas/`, un archivo por semana, para que este archivo no siga creciendo sin límite)
